...
def train(generator, discriminator, init_step, loader, total_iter=600000):
    ...
    log_folder = 'output_%s_%d_%d'%(date_time.date(), date_time.hour, date_time.minute)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trial_name', type=str, default="", help='a brief description of the training trial')
    ...
    # generator.load_state_dict(torch.load('./trial_test1_2021-09-27_9_13/checkpoint/060000_g.model'))
    # g_running.load_state_dict(torch.load('./trial_test1_2021-09-27_9_13/checkpoint/060000_g.model'))
    # discriminator.load_state_dict(torch.load('./trial_test1_2021-09-27_9_13/checkpoint/060000_d.model'))
